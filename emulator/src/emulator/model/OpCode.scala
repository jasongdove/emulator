...
object OpCode {
  val opCodes: Map[Int, OpCode] = List(
    ...
    OpCode(0x0a, Instruction.ASL_A, 1, 2, None),
    OpCode(0x06, Instruction.ASL, 2, 5, Some(AddressingMode.ZeroPage)),
    OpCode(0x16, Instruction.ASL, 2, 6, Some(AddressingMode.ZeroPageX)),
    OpCode(0x0e, Instruction.ASL, 3, 6, Some(AddressingMode.Absolute)),
    OpCode(0x1e, Instruction.ASL, 3, 7, Some(AddressingMode.AbsoluteX)),
    OpCode(0x90, Instruction.BCC, 2, 2, None),
    OpCode(0xb0, Instruction.BCS, 2, 2, None),
    OpCode(0xf0, Instruction.BEQ, 2, 2, None),
    OpCode(0x24, Instruction.BIT, 2, 3, Some(AddressingMode.ZeroPage)),
    OpCode(0x2c, Instruction.BIT, 3, 4, Some(AddressingMode.Absolute)),
    OpCode(0x30, Instruction.BMI, 2, 2, None),
    OpCode(0xd0, Instruction.BNE, 2, 2, None),
    OpCode(0x10, Instruction.BPL, 2, 2, None),
    OpCode(0x00, Instruction.BRK, 1, 7, None),
    OpCode(0x50, Instruction.BVC, 2, 2, None),
    OpCode(0x70, Instruction.BVS, 2, 2, None),
    OpCode(0x18, Instruction.CLC, 1, 2, None),
    OpCode(0xd8, Instruction.CLD, 1, 2, None),
    OpCode(0x58, Instruction.CLI, 1, 2, None),
    OpCode(0xb8, Instruction.CLV, 1, 2, None),
    ...
    OpCode(0xc0, Instruction.CPY, 2, 2, Some(AddressingMode.Immediate)),
    OpCode(0xc4, Instruction.CPY, 2, 3, Some(AddressingMode.ZeroPage)),
    OpCode(0xcc, Instruction.CPY, 3, 4, Some(AddressingMode.Absolute)),
    ...
    OpCode(0x88, Instruction.DEY, 1, 2, None),
    OpCode(0x49, Instruction.EOR, 2, 2, Some(AddressingMode.Immediate)),
    OpCode(0x45, Instruction.EOR, 2, 3, Some(AddressingMode.ZeroPage)),
    OpCode(0x55, Instruction.EOR, 2, 4, Some(AddressingMode.ZeroPageX)),
    OpCode(0x4d, Instruction.EOR, 3, 4, Some(AddressingMode.Absolute)),
    OpCode(0x5d, Instruction.EOR, 3, 4, Some(AddressingMode.AbsoluteX)),
    OpCode(0x59, Instruction.EOR, 3, 4, Some(AddressingMode.AbsoluteY)),
    OpCode(0x41, Instruction.EOR, 2, 6, Some(AddressingMode.IndirectX)),
    OpCode(0x51, Instruction.EOR, 2, 5, Some(AddressingMode.IndirectY)),
    OpCode(0xe6, Instruction.INC, 2, 5, Some(AddressingMode.ZeroPage)),
    OpCode(0xf6, Instruction.INC, 2, 6, Some(AddressingMode.ZeroPageX)),
    OpCode(0xee, Instruction.INC, 3, 6, Some(AddressingMode.Absolute)),
    OpCode(0xfe, Instruction.INC, 3, 7, Some(AddressingMode.AbsoluteX)),
    OpCode(0xe8, Instruction.INX, 1, 2, None),
    OpCode(0xc8, Instruction.INY, 1, 2, None),
